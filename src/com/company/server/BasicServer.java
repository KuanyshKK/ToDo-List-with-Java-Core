...
public abstract class BasicServer {
    ...
    private static HttpServer createServer(String host, int port) throws IOException {
        var msg = "Starting lesson.com.company.server on http://%s:%s/%n";
    ...
    protected final void registerGeneralHandler(String method, String route, RouteHandler handler){
        getRoutes().put(makeKey(method, route), handler);
    }

    protected final void registerGet(String route, RouteHandler handler) {
        registerGeneralHandler("GET",route,handler);
    }
